...
public class LoginForm extends javax.swing.JFrame {
    ...
    public LoginForm() {
        ...
        jPanel1.setBackground(new Color(102,217,255));
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/llaves.png"))); // NOI18N
    ...
    public void validar() {
        ...
        if (txtUser.getText().equals("") || txtPass.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Agregue el campo faltante");
            ...
            if (ev.getUser() != null && ev.getDni() != null) {
                ...
                JOptionPane.showMessageDialog(this, "Debe ingresar un usuario válido");
                txtUser.requestFocus();
            }
        }
    }
